...
// items-center!/py-3! override Alert's own items-start/py-2 - [&>*]:self-center!
// on top of that so the icon/text/close-button each individually center on
// the cross axis too, not just the row's own (empty) alignment intent.
// [&_button]: makes the close button (h-4 w-4, opacity-70 at rest) bigger and fully opaque.
export const toastItemClassName =
	"pointer-events-auto w-full items-center! py-3! [&>*]:self-center! [&_button]:h-6 [&_button]:w-6 [&_button]:opacity-100";
