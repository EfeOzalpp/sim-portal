...
// items-center!/py-4! override Alert's own items-start/py-2. [&_button]: makes the close button (h-4 w-4, opacity-70 at rest) bigger and fully opaque.
export const toastItemClassName =
	"pointer-events-auto w-full items-center! py-4! [&_button]:h-6 [&_button]:w-6 [&_button]:opacity-100";
