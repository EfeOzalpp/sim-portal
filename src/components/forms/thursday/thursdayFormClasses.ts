...
export const selectionButtonClassName =
...
export const dangerSelectionButtonClassName =
	`${selectionButtonClassName} [--button-bg:#f7dddd] [--button-bg-hover:#efcccc] [--button-border:#e4baba] [--button-border-hover:#d9a8a8] [--button-text:#421717] [--button-text-hover:#421717] dark:[--button-bg:#462d2d] dark:[--button-bg-hover:#553535] dark:[--button-border:#6f4747] dark:[--button-border-hover:#805252] dark:[--button-text:#fff0f0] dark:[--button-text-hover:#fff]`;

export const optionRowClassName = "flex items-center gap-[var(--gap-sm)]";

export const optionBadgeClassName =
...
export const selectedOptionBadgeClassName =
	"[--option-badge-bg:#b9e2c9] [--option-badge-border:#98c9ad] [--option-badge-text:#143821] dark:[--option-badge-bg:#4c7154] dark:[--option-badge-border:#548a69] dark:[--option-badge-text:#fff]";
