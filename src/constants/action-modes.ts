...
// and each page's own Edit/Delete button (useActionMode()) coordinate
// through. ActionMode.module.css mirrors these same strings in its
// [data-action-mode="..."] selectors - keep both in sync.
